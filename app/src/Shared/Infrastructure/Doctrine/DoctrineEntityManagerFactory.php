...
namespace Crissanclick\Shared\Infrastructure\Doctrine;

use Crissanclick\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    private static $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Crissanclick\Shared\Domain',
    ];
